        ...
        <div className="row align-items-center">
          <div className="col-auto pr-5" style={{ width: 522 }}>
            ...
            >
              ...
              to make anothe memorable moments.
            </p>
            <Button
              isPrimary
              isBlock
            ...
            <div className="row mt-5">
              <div className="col-auto" style={{ marginRight: 50 }}>
                ...
                />
                <h6 className="mt-3">
                  <b>{formatNumber(props.data.travelers)}</b>{" "}
              ...
              <div className="col-auto" style={{ marginRight: 50 }}>
                ...
                />
                <h6 className="mt-3">
                  <b>{formatNumber(props.data.treasures)}</b>{" "}
                  <span className="text-gray-500 font-weight-light">
                    Treasures
                  </span>
                </h6>
              ...
              <div className="col-auto" style={{ marginRight: 50 }}>
                ...
                />
                <h6 className="mt-3">
                  <b>{formatNumber(props.data.cities)}</b>{" "}
                  <span className="text-gray-500 font-weight-light">
                    Cities
                  </span>
                </h6>
